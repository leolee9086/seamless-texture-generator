    ...
    <div class="project-sidebar flex flex-col h-full bg-[#1e1e1e] border-l border-white/10">
        ...
        <div class="flex-1 overflow-y-auto p-2 space-y-2">
            ...
            >
                ...
                <!-- Active Indicator -->
                <div v-if="activeProjectId === project.id" class="absolute right-2 top-2 w-2 h-2 rounded-full bg-blue-500 shadow-[0_0_8px_rgba(59,130,246,0.8)]"></div>
            ...
            <!-- Empty State -->
            <div v-if="projects.length === 0" class="flex flex-col items-center justify-center py-10 text-white/30 text-xs">
...
const { switchProject, deleteProject, clearAllProjects } = actions
